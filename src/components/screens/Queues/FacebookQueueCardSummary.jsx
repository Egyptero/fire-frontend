...
class FacebookQueueCardSummary extends Component {
  ...
  prepareData = () => {
    ...
    this.state.data.forEach((row) => {
      ...
      if (row.label === "Reviews") {
        if (reviews > row.value) reviewsTrend = "up";
        else if (reviews < row.value) reviewsTrend = "down";
        else if (reviews === row.value) reviewsTrend = "neutral";
      }
...
FacebookQueueCardSummary.propTypes = {
