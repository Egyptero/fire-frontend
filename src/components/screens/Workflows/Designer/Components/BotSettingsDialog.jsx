...
class BotSettingsDialog extends Component {
  ...
  saveBotSetting = () => {
    console.log("Saving Bot Setting");
    const { designer } = this.props;
  ...
  render() {
    ...
    return (
      ...
      >
        <DialogTitle id="form-dialog-title">Bot settings</DialogTitle>
...
export default withStyles(styles, { withTheme: true })(BotSettingsDialog);
