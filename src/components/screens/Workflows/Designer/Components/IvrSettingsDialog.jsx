...
class IvrSettingsDialog extends Component {
  state = {
    workflowId: ""
  };
  componentDidMount() {
  ...
  saveBotSetting = () => {
    console.log("Saving IVR Setting");
    const { designer } = this.props;
  ...
  renderWorkflowSetting = () => {
    ...
    return (
      <FormControl className={classes.formControl}>
        <InputLabel shrink htmlFor="ivr-label-placeholder">
          IVR name
        </InputLabel>
        <Select
  ...
  render() {
    ...
    return (
      ...
      >
        <DialogTitle id="form-dialog-title">IVR settings</DialogTitle>
...
export default withStyles(styles, { withTheme: true })(IvrSettingsDialog);
